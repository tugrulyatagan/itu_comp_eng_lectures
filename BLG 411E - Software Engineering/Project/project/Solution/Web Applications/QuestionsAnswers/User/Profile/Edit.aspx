<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="User_Profile_Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" Runat="Server">
    <div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <asp:TextBox ID="tbUsername" Enabled="false" runat="server"></asp:TextBox>
