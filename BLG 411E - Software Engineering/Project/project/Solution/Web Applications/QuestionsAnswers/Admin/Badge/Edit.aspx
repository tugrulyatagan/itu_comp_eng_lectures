<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Admin_Badge_Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" Runat="Server">
    <div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <asp:TextBox ID="tbImagePath" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="tbImagePath" ValidationGroup="Submit" ErrorMessage="*" runat="server"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
