...
void StaffMember::setName(const string& name_in){name = name_in;}
void StaffMember::setSurname(const string& surname_in){surname = surname_in;}
// Methods to get attributes
unsigned int StaffMember::getCompanyID() const{return companyID;}
const string& StaffMember::getName() const{return name;}
const string& StaffMember::getSurname() const{return surname;}
...
void Intern::setSchoolName(const string& schoolname_in){schoolName = schoolname_in;}
// Method to get additional attribute: schoolName
const string& Intern::getSchoolName() const{return schoolName;}
// Polymorphic print method
...
void Employee::setSocialSecurityNumber(const string& ssn_in){socialSecurityNumber = ssn_in;}
// Method to get additional attribute: socialSecurityNumber
const string& Employee::getSocialSecurityNumber() const{return socialSecurityNumber;}
// Polymorphic print method
